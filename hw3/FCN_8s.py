...
pool3 = MaxPooling2D((2, 2), strides=(2, 2), name='block3_pool', trainable=True)(x)

x = Conv2D(512, (3, 3), activation='relu', padding='same', name='block4_conv1', trainable=True)(pool3)
...
pool4 = MaxPooling2D((2, 2), strides=(2, 2), name='block4_pool', trainable=True)(x)

x = Conv2D(512, (3, 3), activation='relu', padding='same', name='block5_conv1', trainable=True)(pool4)
...
fcn_model.save('FCN_8s_epoch1.h5')
fcn_model.fit(sat, mask, epochs= 14, batch_size= 15 )
fcn_model.save('FCN_8s_epoch15.h5')
fcn_model.fit(sat, mask, epochs= 15, batch_size= 15 )
fcn_model.save('FCN_8s_epoch30.h5')
